class AccountsController < ApplicationController
  ...
  layout "application", :except => :pdftest
	...
	active_scaffold :account do |config|
		config.columns = [:number, :name, :description, :balance, :fiscal_period, :account_type, :account]
		config.list.columns.exclude :fiscal_period, :account_type, :account
		config.create.columns.exclude :balance
		config.create.columns = [:name, :number, :description, :fiscal_period, :account_type, :account]
#		config.columns[:account].ui_type = :option
		config.columns[:number].sort      = false
